...
from settings import GEMINI_LLM, INDEX_STORAGE, SLIDES_FILE
from slides import Slide, SlideDeck


def generate_slides(topic: str) -> None:
    """Generates slide for a given topic.
    ...
    with st.spinner("Preparing summaries and keywords..."):
        ...
        key_extractor = KeywordExtractor(keywords=10, llm=GEMINI_LLM)
